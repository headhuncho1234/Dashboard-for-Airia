export default async function handler(req, res) {
  ...
  const VALID_AGENTS = [
    ...
    "197b7527-226d-46ce-a79e-1f97b3108aa4",
    "6c9002a0-7b57-415a-bc83-9e547c08f94e",
    "d50a4471-9198-48ae-8072-3bfef9d83b73",
  ];
  ...
  try {
    ...
    const timeout = setTimeout(() => controller.abort(), 270000); // 270s — just under Vercel's 300s cap
    ...
    if (err.name === "AbortError") {
      return res.status(504).json({ error: "Agent timed out after 270 seconds" });
    }
